...
var myRect1 = new Rectangle(10,20); 
var myRect2 = new Rectangle(20,30);
var myRect3 = new Rectangle(50,70);
...
Person1 = new Person("Nalini","Pogula",22,['javascript','C#'],"19/02/1999",{city:"hyderabad",pincode:500074},"false","Developer");
Person2 = new Person("Nandini","Pogula",24,["Nodejs","Javascript"],"16/1/1997",{city:"hyderabad",pincode:500074},"false","Developer");
...
var obj1 = new Account(98765,"Nalini",76499);
console.log(obj1);


var objSavings = new Savings("true",63545,"Nandu",34245); 
console.log(objSavings);
console.log(objSavings.withdraw(900));
console.log(objSavings.getCurrentBalance());

var objCurrent = new Current(700,342313,"Aradhya",5467878); 
